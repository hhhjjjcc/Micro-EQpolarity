...
# File path
file_path = "mt_solution_group1_20250319.txt"
...
# Print average values and standard deviations
...
for event in filtered_events:
    ...
    color = (1, normalized_deviation, normalized_deviation)  # RGB color definition
...
# For Stress
# Sigma 1
x1, y1 = stereonet_projection(47, 3)
plt.scatter(x1, y1, color='purple', marker='o', s=200, edgecolor='black', linewidth=1, zorder=5)

# Sigma 2
x2, y2 = stereonet_projection(284, 84)
plt.scatter(x2, y2, color='green', marker='s', s=200, edgecolor='black', linewidth=1, zorder=5)

# Sigma 3
x3, y3 = stereonet_projection(138, 5)
plt.scatter(x3, y3, color='yellow', marker='^', s=200, edgecolor='black', linewidth=1, zorder=5)

# Add legend
legend_elements = [
    plt.scatter([], [], color='purple', edgecolor='black', linewidth=1, marker='o', s=100, label='σ1 (47°/3°)'),
    plt.scatter([], [], color='green', edgecolor='black', linewidth=1, marker='s', s=100, label='σ2 (284°/84°)'),
    plt.scatter([], [], color='yellow', edgecolor='black', linewidth=1, marker='^', s=100, label='σ3 (138°/5°)')
]
