...
<div style="text-align: center;">
  <img src="[https://github.com/hhhjjjcc/Micro-EQpolarity/blob/main/figure/workflow_transfer_learning_V10.jpeg]" width="70%">
...
### Description
This section includes a series of scripts showing analyses in the ToC2ME area based on FMSs, including spatial distribution, magnitude distribution, and FMSs classification.
